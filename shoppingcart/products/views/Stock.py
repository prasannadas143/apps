...
def InStock(request, id):
    ...
    if productobj.is_digital:
        attributes = Attributes.objects.filter( attribute_product = productobj)
    ...
    return render(request, templatename, {"id": id,  "stockdetails" : stockdetails , "showattributes" : showattributes, "stock_cnt" : stock_cnt })
