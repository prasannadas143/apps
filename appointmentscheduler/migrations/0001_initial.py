# -*- coding: utf-8 -*-
# Generated by Django 1.10.7 on 2017-06-02 12:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_dayoff', models.CharField(blank=True, max_length=1, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('service_name', models.CharField(blank=True, max_length=100, null=True, unique=True)),
                ...
                ('after', models.SmallIntegerField()),
        ...
        migrations.AlterUniqueTogether(
            name='appschedulerdates',
            unique_together=set([('foreign_id', 'type', 'date')]),
        ),
    ]
